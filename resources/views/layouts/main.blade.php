    ...
    <div class="main-wrapper">
      ...
      <div class="main-sidebar">
        <aside id="sidebar-wrapper">
          <div class="sidebar-brand">
            @foreach($web as $webs)
              @if($webs->logo)
                <img alt="image" src="{{ Storage::url($webs->logo)}}" class="img-fluid mr-5 mt-4" style="width:150px;">
              @else
      ...
      <footer class="main-footer">
        <div class="footer-left">
          Copyright &copy; 2022 <div class="bullet"></div> <a href="https://tahungoding.com/" @if(isset($primary_color)) style="color: {{$primary_color}}" @else style="color: #6777ef;" @endif>TAHUNGODING</a>
        </div>
      </footer>
    </div>
  </div>
