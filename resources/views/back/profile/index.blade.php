                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-6 col-12">
                                    ...
                                    <input type="file" class="form-control dropify" name="photo"
                                        data-allowed-file-extensions="png jpg jpeg svg" data-show-remove="false" data-default-file="@if(!empty(Auth::user()->photo) && file_exists(public_path('images/user/'. Auth::user()->photo))) {{ asset('images/user/'. Auth::user()->photo) }} @endif">
                                </div>
                            </div>
