      ...
      <form action="{{ route('kecelakaan.update', $data->id) }}" method="post" id="editKecelakaanForm{{$data->id}}"
        ...
        <div class="modal-body">
            <div class="form-group">
              ...
              <div class="form-group">
                <label for="latitude">Latitude</label>
                <input type="text" id="editLatitude" name="edit_latitude" class="form-control" value="{{ $data->latitude }}" readonly>
              </div>
              <div class="form-group">
                <label for="longitude">Longitude</label>
                <input type="text" id="editLongitude" name="edit_longitude" class="form-control" value="{{ $data->longitude }}" readonly>
              </div>
        </div>
        <div class="modal-footer bg-whitesmoke br">
          <button type="button" class="btn btn-secondary" data-dismiss="modal">Kembali</button>
