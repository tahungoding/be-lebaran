...
@section('title', 'Detail Kecelakaan')
@section('css')
    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item active"><a href="{{ url()->current() }}">Detail Kecelakaan</a></div>
            </div>
        </div>
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="form-group col-md-12 col-12">
                            ...
                            <textarea name="edit_ringkas_kejadian" class="form-control" style="height: 30vh;" readonly>{{ $kecelakaan->ringkas_kejadian }}</textarea>
                        </div>
                        <div class="form-group col-md-12 col-12">
                        ...
                        <div class="form-group col-md-12 col-12">
                            ...
                            <div class="gallery" style="overflow: hidden;">
                                @if($kecelakaan->file_pendukung && !empty($kecelakaan->file_pendukung))
                                <a href="{{ $kecelakaan->file_pendukung }}"><img src="{{ $kecelakaan->file_pendukung }}" style="width: 150px; height: 150px; object-fit: cover;"/></a>
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="form-group col-md-6 col-12">
                            ...
                            <input type="text" name="edit_latitude" id="ppp" class="form-control" value="{{ $kecelakaan->latitude }}" readonly>
                        </div>
                        <div class="form-group col-md-6 col-12">
                            <label>Longitude</label>
                            <input type="text" name="edit_longitude" id="longitude" class="form-control" value="{{ $kecelakaan->longitude }}" readonly>
                        </div>
                    </div>
...
<script>
    ...
    <script type="text/javascript">
        ...
        var map = L.map('map', {
            ...
            center: [{{ $kecelakaan->latitude }}, {{ $kecelakaan->longitude }}],
            // Set the initial zoom level, values 0-18, where 0 is most zoomed-out (required)
            zoom: 15
        });
        L.control.scale().addTo(map);
        var marker;
        var marker = L.marker([{{ $kecelakaan->latitude }},{{ $kecelakaan->longitude }}]).addTo(map);
