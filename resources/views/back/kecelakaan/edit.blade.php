    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item active"><a href="{{ url()->current() }}">Edit Kecelakaan</a></div>
            </div>
        </div>
                    ...
                    <form action="{{ route('kecelakaan.update', $kecelakaan->id) }}" method="post"
                        ...
                        <div class="row">
                            <div class="form-group col-md-12 col-12">
                                ...
                                <textarea name="edit_ringkas_kejadian" class="form-control"
                                    style="height: 30vh;">{{ $kecelakaan->ringkas_kejadian }}</textarea>
                            </div>
                            <div class="form-group col-md-12 col-12">
                            ...
                            <div class="form-group col-md-12 col-12">
                                ...
                                <input type="file" class="form-control dropify" name="edit_file_pendukung" id="edit_file_pendukung"
                                    data-allowed-file-extensions="png jpg jpeg" data-show-remove="false" data-default-file="{{ $kecelakaan->file_pendukung }}">
                            </div>
        ...
        $(document).ready(function() {
            ...
            $("#editKecelakaanForm").validate({
                ...
                submitHandler: function(form) {
                    $("#editKecelakaanButton").prop('disabled', true);
                    form.submit();
                }
            });
