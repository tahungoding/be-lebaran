...
@section('title', 'Tambah Pos Gatur')
@section('css')
...
@section('container')
    <section class="section">
        <div class="section-header">
            <h1>Tambah Pos Gatur</h1>
            <div class="section-header-breadcrumb">
                <div class="breadcrumb-item">Dashboard</div>
                <div class="breadcrumb-item">Pos Gatur</div>
                <div class="breadcrumb-item active"><a href="{{ url()->current() }}">Tambah Pos Gatur</a></div>
            </div>
        </div>
        ...
        <div class="section-body">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('pos-gatur.store') }}" method="post" id="tambahPosGaturForm">
                        @csrf
                        <div class="row">
                            ...
                            <div class="form-group col-md-6 col-12">
                                ...
                                <select name="pos_id" class="form-control">
                                    @foreach ($pos as $posData)
                                        <option value="{{ $posData->id }}">{{ $posData->nama }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
        ...
        $(document).ready(function() {
            ...
            $("#tambahPosGaturForm").validate({
                ...
                messages: {
                    ...
                    pos_id: {
                        required: "Pos Kejadian harus di isi",
                    },
                    latitude: {
